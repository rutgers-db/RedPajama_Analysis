set terminal png
set output 'book_fn_fp.png'
# set yrange [-0.3:1.2]
# set xrange [-0.3:1.2]
# set logscale y 10

plot './data/book.txt' every ::0::0 using 2:3:1 with labels offset char 3,0 notitle, '' every ::0::0 using 2:3 with points pt 7 lc rgb "purple" title 'K = 128', \
