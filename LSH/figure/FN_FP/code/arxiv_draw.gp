set terminal png
set output 'arxiv_fn_fp.png'
# set yrange [:1.2]
# set xrange [-0.3:1.2]
# set logscale y 10

plot './data/arxiv.txt' every ::0::0 using 2:3:1 with labels offset char 3,0 notitle, '' every ::0::0 using 2:3 with points pt 7 lc rgb "purple" title 'K = 128', \
     '' every ::1::1 using 2:3:1 with labels offset char 3,0  point pt 7 notitle , '' every ::1::1 using 2:3 with points pt 7 lc rgb "purple"  notitle, \
     ...
     '' every ::5::5 using 2:3:1 with labels offset char 3,0  point pt 7 notitle , '' every ::5::5 using 2:3 with points pt 7 lc rgb "red"  notitle, \
     ...
     '' every ::8::8 using 2:3:1 with labels offset char 3,0  point pt 7 notitle , '' every ::8::8 using 2:3 with points pt 7 lc rgb "blue" notitle, \
