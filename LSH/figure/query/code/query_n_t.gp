...
# Plot the data
plot './data/query_time_n_t.txt' using 2:xtic(1) title 't=25' lt rgb "purple" fs pattern 1, '' using 3 title 't=50' lt rgb "forest-green" fs pattern 2, '' using 4 title 't=100' lt rgb "medium-blue" fs pattern 37
